...
import com.example.a160420066w6.viewmodel.ListViewModel
import com.example.a160420066w6.databinding.FragmentPlaneListBinding
...
class PlaneListFragment : Fragment() {
    ...
    fun observeViewModel(){
        viewModel.planeLoadErrorLD.observe(viewLifecycleOwner, Observer {
            if(it == true) {
        ...
        viewModel.planeLD.observe(viewLifecycleOwner, Observer{
